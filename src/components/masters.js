            ...
            <div class="row">
              <div class="col-sm-12 col-md-12 col-lg-12 text-center sub_section">
                <div class="container">
                  ...
                  <a style={{ textDecoration: "none" }} class="float-right text-white btn_dashboard dashboardbtn" onClick={() => Navigate("/dashboard")}><i class="fa fa-home" />Go To Dashboard</a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="container">
            <div class="col-md-12 table_section tab-section">
              <ul class="nav nav-tabs" role="tablist">
                <li class="nav-item">
                  <span class="nav-link active" style={{ color: "black", cursor: "pointer" }} data-toggle="tab" id="companytab" onClick={() => Navigate("/masters")}>Company</span>
                </li>
                <li class="nav-item">
                  <span class="nav-link" data-toggle="tab" style={{ color: "black", cursor: "pointer" }}  onClick={() => Navigate("/corporate")}>Corporate</span>
                </li>
              </ul>
              ...
              <div class="row table_box">
                <div class="float-right " style={{ textAlign: "end" }}>
                  <button onClick={() => Navigate('/addCompany')} class="btn-sm btn-add-field" id="add-edit-company" ><i class="fa fa-plus"></i><a style={{ color: "white", textDecoration: "none" }}  >Add Company</a></button>
                </div>
                <table class="table">
                  <thead>
                    <tr>
